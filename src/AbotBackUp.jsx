    ...
    <>
      <div className="  brightness-125 flex bg-[#1a1a1a] items-center justify-center border-solid border  h-[282vh] lg:h-[196vh] w-screen ">
        <div className=" h-[260vh] lg:h-[174vh] border-solid border-[11px] border-[red] w-[85vw] lg:gap-4 gap-7  flex-col items-center   flex   ">
          ...
          <div className=" lg:h-[9.5vh] h-[9vh]  rounded-lg bg-[#121212] flex flex-row  items-center justify-center w-[60.3vw] lg:w-[25.8vw]">
            <div className="w-[59.1vw] lg:w-[24.7vw] flex flex-row h-[7vh] lg:h-[7.3vh]  gap-1 lg:gap-0  items-center justify-between">
              ...
              <button  id={ExperienceButton} onClick={ExperienceToggling} className="cursor-pointer rounded-lg flex items-center justify-center w-[20vw] h-full lg:w-[8.9vw] ">
                {" "}
                <p className="carlito  font-[600] ">
                  Experience
                </p>
          ...
          <div className=" h-[240vh] lg:h-[102vh]  w-full  flex flex-col justify-end lg:flex-row lg:items-end lg:justify-center ">
