    ...
    <>
      <div className="bg-[#0c0d08] h-[151vh]  w-screen flex justify-center items-center ">
        <div className="h-[131vh]  w-full gap-3  flex-col items-center justify-center  flex   ">
          <div className="flex flex-col    lg:h-[19vh] w-[80vw] lg:w-[68vw]">
            <div className="flex flex-col items-center   lg:h-[19vh] gap-4  lg:gap-8  w-full">
              ...
              <div className=" flex flex-row   items-center justify-center text-center  w-full lg:w-[40vw] leading-tight h-[7vh]  ">
          ...
          <div className="lg:w-full  w-screen gap-6    h-[105vh]">
