...
import MobileTestimonial from "./MobileTestimonial.jsx";
import "./global.css";
...
function Testimonial() {
  ...
  return (
    <div className="bg-[#1a1a1a] lg:h-[115vh] h-[100vh]  w-screen flex justify-center items-center ">
      <div className="lg:h-[93vh] h-[78vh] w-[85vw] gap-3  flex-col items-center justify-center  flex   ">
        ...
        <div className="overflow-x-hidden overflow-y-hidden h-[80vh] lg:invisible visible lg:absolute relative w-[85vw] flex items-center justify-start">
          <MobileTestimonial />
        </div>
